...
public class MathQ1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_next = findViewById(R.id.bt_nextQ1Math);
        rl =  findViewById(R.id.my_layout);
        switch(sp.getString("Style","Style1")){
            case "Style1":
                rb_Q1WA1Math.setTextColor(getColor(R.color.gold));
                rb_Q1WA2Math.setTextColor(getColor(R.color.gold));
                rb_Q1WA3Math.setTextColor(getColor(R.color.gold));
                rb_Q1RAMath.setTextColor(getColor(R.color.gold));
                ...
                break;
            case "Style2":
                rb_Q1WA1Math.setTextColor(getColor(R.color.cyan));
                rb_Q1WA2Math.setTextColor(getColor(R.color.cyan));
                rb_Q1WA3Math.setTextColor(getColor(R.color.cyan));
                rb_Q1RAMath.setTextColor(getColor(R.color.cyan));
                ...
                break;
            case "Style3":
                rb_Q1WA1Math.setTextColor(getColor(R.color.brown));
                rb_Q1WA2Math.setTextColor(getColor(R.color.brown));
                rb_Q1WA3Math.setTextColor(getColor(R.color.brown));
                rb_Q1RAMath.setTextColor(getColor(R.color.brown));
