...
public class ChemistryQ3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_next = findViewById(R.id.bt_nextQ3Chemistry);
        bt_back = findViewById(R.id.bt_backQ3Chemistry);
        rl =  findViewById(R.id.my_layout);
        switch(sp.getString("Style","Style1")){
            case "Style1":
                rb_Q3WA1Chemistry.setTextColor(getColor(R.color.gold));
                rb_Q3WA2Chemistry.setTextColor(getColor(R.color.gold));
                rb_Q3WA3Chemistry.setTextColor(getColor(R.color.gold));
                rb_Q3RAChemistry.setTextColor(getColor(R.color.gold));
                ...
                break;
            case "Style2":
                rb_Q3WA1Chemistry.setTextColor(getColor(R.color.cyan));
                rb_Q3WA2Chemistry.setTextColor(getColor(R.color.cyan));
                rb_Q3WA3Chemistry.setTextColor(getColor(R.color.cyan));
                rb_Q3RAChemistry.setTextColor(getColor(R.color.cyan));
                ...
                break;
            case "Style3":
                rb_Q3WA1Chemistry.setTextColor(getColor(R.color.brown));
                rb_Q3WA2Chemistry.setTextColor(getColor(R.color.brown));
                rb_Q3WA3Chemistry.setTextColor(getColor(R.color.brown));
                rb_Q3RAChemistry.setTextColor(getColor(R.color.brown));
