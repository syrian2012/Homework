...
public class MathQ3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_next = findViewById(R.id.bt_nextQ3Math);
        bt_back = findViewById(R.id.bt_backQ3Math);
        rl =  findViewById(R.id.my_layout);
        switch(sp.getString("Style","Style1")){
            case "Style1":
                rb_Q3WA1Math.setTextColor(getColor(R.color.gold));
                rb_Q3WA2Math.setTextColor(getColor(R.color.gold));
                rb_Q3WA3Math.setTextColor(getColor(R.color.gold));
                rb_Q3RAMath.setTextColor(getColor(R.color.gold));
                ...
                break;
            case "Style2":
                rb_Q3WA1Math.setTextColor(getColor(R.color.cyan));
                rb_Q3WA2Math.setTextColor(getColor(R.color.cyan));
                rb_Q3WA3Math.setTextColor(getColor(R.color.cyan));
                rb_Q3RAMath.setTextColor(getColor(R.color.cyan));
                ...
                break;
            case "Style3":
                rb_Q3WA1Math.setTextColor(getColor(R.color.brown));
                rb_Q3WA2Math.setTextColor(getColor(R.color.brown));
                rb_Q3WA3Math.setTextColor(getColor(R.color.brown));
                rb_Q3RAMath.setTextColor(getColor(R.color.brown));
