...
public class PhysicsQ2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_next = findViewById(R.id.bt_nextQ2Physics);
        bt_back = findViewById(R.id.bt_backQ2Physics);
        rl =  findViewById(R.id.my_layout);
        switch(sp.getString("Style","Style1")){
            case "Style1":
                rb_Q2WA1Physics.setTextColor(getColor(R.color.gold));
                rb_Q2WA2Physics.setTextColor(getColor(R.color.gold));
                rb_Q2WA3Physics.setTextColor(getColor(R.color.gold));
                rb_Q2RAPhysics.setTextColor(getColor(R.color.gold));
                ...
                break;
            case "Style2":
                rb_Q2WA1Physics.setTextColor(getColor(R.color.cyan));
                rb_Q2WA2Physics.setTextColor(getColor(R.color.cyan));
                rb_Q2WA3Physics.setTextColor(getColor(R.color.cyan));
                rb_Q2RAPhysics.setTextColor(getColor(R.color.cyan));
                ...
                break;
            case "Style3":
                rb_Q2WA1Physics.setTextColor(getColor(R.color.brown));
                rb_Q2WA2Physics.setTextColor(getColor(R.color.brown));
                rb_Q2WA3Physics.setTextColor(getColor(R.color.brown));
                rb_Q2RAPhysics.setTextColor(getColor(R.color.brown));
