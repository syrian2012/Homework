...
public class MathQ4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_next = findViewById(R.id.bt_nextQ4Math);
        bt_back = findViewById(R.id.bt_backQ4Math);
        rl =  findViewById(R.id.my_layout);
        switch(sp.getString("Style","Style1")){
            case "Style1":
                rb_Q4WA1Math.setTextColor(getColor(R.color.gold));
                rb_Q4WA2Math.setTextColor(getColor(R.color.gold));
                rb_Q4WA3Math.setTextColor(getColor(R.color.gold));
                rb_Q4RAMath.setTextColor(getColor(R.color.gold));
                ...
                break;
            case "Style2":
                rb_Q4WA1Math.setTextColor(getColor(R.color.cyan));
                rb_Q4WA2Math.setTextColor(getColor(R.color.cyan));
                rb_Q4WA3Math.setTextColor(getColor(R.color.cyan));
                rb_Q4RAMath.setTextColor(getColor(R.color.cyan));
                ...
                break;
            case "Style3":
                rb_Q4WA1Math.setTextColor(getColor(R.color.brown));
                rb_Q4WA2Math.setTextColor(getColor(R.color.brown));
                rb_Q4WA3Math.setTextColor(getColor(R.color.brown));
                rb_Q4RAMath.setTextColor(getColor(R.color.brown));
