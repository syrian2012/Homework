...
public class PhysicsQ4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_next = findViewById(R.id.bt_nextQ4Physics);
        bt_back = findViewById(R.id.bt_backQ4Physics);
        rl =  findViewById(R.id.my_layout);
        switch(sp.getString("Style","Style1")){
            case "Style1":
                rb_Q4WA1Physics.setTextColor(getColor(R.color.gold));
                rb_Q4WA2Physics.setTextColor(getColor(R.color.gold));
                rb_Q4WA3Physics.setTextColor(getColor(R.color.gold));
                rb_Q4RAPhysics.setTextColor(getColor(R.color.gold));
                ...
                break;
            case "Style2":
                rb_Q4WA1Physics.setTextColor(getColor(R.color.cyan));
                rb_Q4WA2Physics.setTextColor(getColor(R.color.cyan));
                rb_Q4WA3Physics.setTextColor(getColor(R.color.cyan));
                rb_Q4RAPhysics.setTextColor(getColor(R.color.cyan));
                ...
                break;
            case "Style3":
                rb_Q4WA1Physics.setTextColor(getColor(R.color.brown));
                rb_Q4WA2Physics.setTextColor(getColor(R.color.brown));
                rb_Q4WA3Physics.setTextColor(getColor(R.color.brown));
                rb_Q4RAPhysics.setTextColor(getColor(R.color.brown));
